  ...
  meta: [
    {
      name: 'description',
      content:
        'Fintech platform engineer: brokerage CRM, back office, trading infrastructure. Rust, Go, TypeScript. 8+ years shipping, 6+ in retail brokerage.',
    },
    { property: 'og:title', content: 'Muhammad Fatih Al-Aziz - Fintech Platform Engineer' },
    { property: 'og:description', content: 'Brokerage CRM, back office, and trading infrastructure. Rust, Go, TypeScript.' },
...
.fc-dot-mark {
  ...
  height: 0.58rem;
  flex: 0 0 auto;
  border: 1.5px solid #e79aa3;
  border-radius: 50%;
  background: rgba(255, 154, 164, 0.28);
